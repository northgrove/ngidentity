...
exports.getToken = () => {
  return async (req, res) => {
    const accessToken = await token.getAccessToken(
      config.tokenURI,
      '9312bfff-2c48-469d-93df-2703c8bbd194' //'c46831b2-d939-49eb-b1ea-68e259a90f1d' //process.env['AZURECONFIG_CLIENTID']
    )
...
exports.getTokenOnBehalf = () => {
  return async (req, res) => {
    ...
    const accessToken = await token.getAccessTokenOnBehalf(
      config.tokenURI,
      oldAccessToken,
      '9312bfff-2c48-469d-93df-2703c8bbd194' //'e014b351-88c6-4936-be72-321c316b761f'
    )
    res.send(accessToken)
  }
}
...
exports.verifyToken = () => {
  return async (req, res) => {
    ...
    const config = {
      ...
      ISS: 'https://sts.windows.net/cf4651db-0b4d-49b2-88e6-e79dee56ea76/',
